...
class WorkflowTests(unittest.TestCase):
    ...
    def test_brief_builder_is_packaged(self):
        ...
        self.assertIn("validateForExport", source)
        self.assertIn("validateStatePayload", source)
        self.assertIn("aria-valuetext", source)
        self.assertIn("64 character permutations", source)
        self.assertIn('role="radiogroup"', source)
        self.assertIn("Customize delivery", source)
        self.assertIn("conceptCount: 20", source)
